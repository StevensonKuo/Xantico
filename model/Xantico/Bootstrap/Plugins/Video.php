...
namespace Xantico\Bootstrap\Plugins;
...
{
    const PLYR_CSS_CDN_URL = "https://cdn.plyr.io/3.4.3/plyr.css"; // array, video source. with video type.
    const PLYR_JS_CDN_URL = "https://cdn.plyr.io/3.4.3/plyr.js"; // string, video cover.
    const PLYR_SPRITE_SVG_CDN_URL = "https://cdn.plyr.io/1.3.5/sprite.svg"; // array, subtitle. with options

    private static $moduleTypeArr = array("html5", "plyr", ""); // boolean.
    private static $modeArr = array("video", "audio", "youtube"); // string

    protected $source; // strint, for youtube.
    protected $poster; // array
    protected $track;
    protected $withControls;
    protected $moduleType;
    protected $dataVideoId;
    protected $setup;
...
const player = new Plyr('#" . $video->getId() . "');
     ...
     * {@inheritDoc}
     * @see \model\Xantico\basic\Typography::setMode()
     */

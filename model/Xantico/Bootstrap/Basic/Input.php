...
class Input extends Typography implements RequiredInputInterface
{
    ...
    protected $inputType; // label text color set.
    protected $name; // string, small text bellow the input field.
    protected $placeholder; // boolean
    protected $defaultValue; // boolean
    protected $labelRatio; // boolean; preserved
    protected $textContext; // array; for checkbox and radio.
    protected $help; // array|int|string for radio and checkbox.
    protected $isDisabled; // array|int|string for radio and checkbox.
    protected $isReadonly; // boolean, for radios and checkboxes.
    protected $isStatic; // boolean, for select
    protected $options;
    protected $defaultOption = array(); // string, add form-control class
    protected $disabledOption = array(); // string
    ...
    protected $isFormControl;
    protected $validationState;
    protected $hasFeedback;
    protected $validation;

    /**
     * @param string $inputType
     * @param array $vars
     * @return \model\Xantico\basic\Input
     */

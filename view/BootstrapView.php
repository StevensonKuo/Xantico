...
//         var_dump(Typography::getErrMsg());
    ...
    public function demoView () {
        ...
        if (strtolower($_SERVER ['REQUEST_METHOD']) == "post") {
            ...
            /* sample to show Jumbtron creating.
            $jumbtron = new Jumbotron();
            $jumbtron->setHeader("Hello world!");
            $blockquote = new Typography("blockquote");
            $blockquote->setInnerText("This is made by Xantico");
            $blockquote->setInnerElements(new Typography("footer", array ("innerText" => "Stevenson Kuo")));
            $jumbtron->setBodyContents($blockquote);
            $jumbtron->enclose($container);
            // $container->setInnerElements ($jumbtron);
            //          $container->setIsFluid();
             *
             */
